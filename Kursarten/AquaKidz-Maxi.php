             ...
             <div class="card first-card-aqua">
                 <div class="card-body">
                     <div class="font-color">
                         <h1 class="card-title card-title-style" style="font-size:32px"> AQUAMAXI</h1>
                         <small class="card-text" style="font-size:16px">Mit Sicherheit & Spass zur Schwimm-Kompetenz
</small>
                         <p class="card-text" style="font-size:16px; margin-top:10px;">Schwimmen lernen soll Spass machen, sicher sein und die Entwicklung des Kindes langzeitig fördern. Deswegen legen wir grossen Wert darauf das in unsere Kursen optimalen Lernbedingungen und kindgerechter Motivation verwendet werden. Die grösse der Gruppen ist niveaugerecht und hilft unseren Kursleitern wissen sorgfältig zu vermitteln und Teilnehmer individuell zu unterstützen. Gemeinsam in einer Gruppe gleichaltriger lernen Kinder so Grundlagen die sie zu erfolgreichen Schwimmern macht, im Becken und anderen Wasseraktivitäten.</p>
         ...
         <form action="" method="post">
             ...
             <div class="Card-find-aqua">
                 ...
                 <div class="aquababy-box-überschrift">
                     <h1 style="margin-left: 10px; color:white;">AQUAMAXI KURSE FINDEN</h1>
                 </div>
...
if($viewsearch_aquababy_postleitzahl == "x"){
    $result = mysqli_query($con_mysqli,"SELECT * FROM kurse WHERE (fm_marke in ('AquaVacation','AquaKidz Maxi') AND fm_status='veröffentlicht') OR (fm_status='ongoing' AND fm_marke in ('AquaVacation','AquaKidz Maxi')) order by fm_status='ongoing' DESC,  fm_von_datum_html ASC");
} else{
