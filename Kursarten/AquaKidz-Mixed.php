             ...
             <div class="card first-card-aqua">
                 <div class="card-body">
                     <div class="font-color">
                         <h1 class="card-title card-title-style" style="font-size:32px"> AQUAMIXED</h1>
                         <small class="card-text" style="font-size:16px">Kompetenzen und Freude im Wasser steigern im freien Schwimmtraining</small>
                         <p class="card-text" style="font-size:16px; margin-top:10px;">Die Zeit im Wasser ist eine der glücklichsten Zeiten als Kind. Es ist nicht nur eine gesunde Freizeitgestaltung die Spass macht, sondern auch der beste Ort um das Können und das Vertrauen in sich selbst zu steigern. Aufbauend auf den Grundlagen von den AquaKidz Maxi – Kursen verbessern wir die Technik der 4 Schwimmstile (Kraul, Brust, Rücken, Delfin) und trainieren Ausdauer, Kraft und Koordination. Egal ob ihr Kind besser in den Grundlagen werden will, sie sich auf die Jagd nach Schwimmabzeichen machen oder sie das training als Vorbereitung auf das Vereinsschwimmen nutzen wollen, unsere Kurse und Kursleiter helfen Ihnen auf dem Weg zum Ziel. </p>
         ...
         <form action="" method="post">
             ...
             <div class="Card-find-aqua">
                 ...
                 <div class="aquababy-box-überschrift">
                     <h1 style="margin-left: 10px; color:white;">AQUAMIXED KURSE FINDEN</h1>
                 </div>
