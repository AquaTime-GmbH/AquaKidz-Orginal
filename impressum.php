...
?>
   ...
   <div class="container">
     ...
     <div class="row row-card-imp" style="margin-top:90px; margin-bottom:70px;">
       <div class="card-for-imp ">
         <div class="row">

           <i class="fas fa-mobile-alt icon-costumizing-imp"></i>
           <p class="text-imp"> Telefon Büro: 041 852 05 53</br> Natel: 077 423 58 38 </p>
       ...
       <div class="card-for-imp ">
         <div class="row">
           ...
           <i class="fas fa-envelope-open-text icon-costumizing-imp"></i>
           <p class="text-imp"> Email: schwimmschule@aquakidz.ch</br> Internet: https://aquakidz.ch </p>
       ...
       <div class="card-for-imp ">
         <div class="row">
           ...
           <i class="fas fa-mobile-alt icon-costumizing-imp"></i>
           <p class="text-imp" style="font-weight:bold;">AquaKidz Schwimmschule</p> </br>
           <p class="text-imp">Bahnhofstrasse 32, 6403 Küssnacht am Rigi </p>
