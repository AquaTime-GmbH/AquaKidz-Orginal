   ...
   <div class="container">
        ...
        <div class="col-sm-2"style="width:246px; height:279;">
            ...
            <p class="footer-links" >
                ...
                <a class="footer-text" href="<?php echo $url_helper;?>Kursarten/AquaKidz-Maxi">AquaKidz Mini
                <small>ca. 2 bis 3 Jahre</small>
                </a>

                <a class="footer-text" href="<?php echo $url_helper;?>Kursarten/AquaKidz-Mini">AquaKidz Maxi
