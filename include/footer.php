...
<div id="cookie_popup">
 <div class="hinweis">
    ...
    <div class="row" class="pos">
        ...
        <div class="content">
        <p>Diese Datenschutzerklärung soll die Nutzer dieser Website gemäß europäschischer Datenschutzgrundverordnung (DSGVO) über die Art, den Umfang und den Zweck der Erhebung und Verwendung personenbezogener Daten durch den Websitebetreiber Sebastian Prohaska informieren.
...
<li>Verwendete IP-Adresse</li> Die erhobenen Daten dienen lediglich statistischen Auswertungen und zur Verbesserung der Website. Der Websitebetreiber behält sich allerdings vor, die Server-Logfiles nachträglich zu überprüfen, sollten konkrete Anhaltspunkte auf eine rechtswidrige Nutzung hinweisen.
</ul>
</p>
        </div>
        <button type="button" class="collapsible">Cookies</button>
        <div class="content">
        <p>Diese Website verwendet Cookies. Dabei handelt es sich um kleine Textdateien, welche auf Ihrem Endgerät gespeichert werden. Diese richten keinerlei Schaden an. Ihr Browser greift auf diese Dateien zu. Durch den Einsatz von Cookies erhöht sich die Benutzerfreundlichkeit und Sicherheit dieser Website.
...
Diese Datenschutzerklärung wurde von ithelps - SEO Agentur und Webdesign Wien rechtmäßig kopiert.</p>
        </div>
 </div>
        </div>
